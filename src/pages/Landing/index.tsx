...
export function Landing() {
  return (
    <>
      <main className='bg-fundo h-screen bg-cover bg-no-repeat'>
        <header className=' px-[100px] py-3 flex justify-between bg-white backdrop-brightness-50 bg-opacity-25 backdrop-blur-xl'>
